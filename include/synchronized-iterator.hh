        ...
        public:
            ...
            */
            bool advance()
            {
                ...
                {
                    // positions[i]: ukazazel na zacatek (postupne se posunuje) moves z daneho stavu automatu i
                    // ends[i]: ukazazel na konec moves z daneho stavu automatu i
                    /*std::cout << "POS: aut0 (--[" << this->positions[0]->symbol << "]-->[";
                    for (auto a: this->positions[0]->states_to)
                        std::cout << a << ",";
                    std::cout << "]) aut" << i << " (--[" << this->positions[i]->symbol << "]-->[";
                    for (auto a: this->positions[i]->states_to)
                        std::cout << a << ","; 
                    std::cout << "])\n";*/
